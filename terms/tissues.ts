export const tissuesA = {
  ...
  "sweat gland" : "gland that helps cool certain areas of the body (incl. 'gland')",
  ...
  "sensation" : "paSs",
  "bending" : "what helps cillia know they need to tell the body about a substance nearby",
  ...
  "basal surface" : "anchored lower surface of epithelial cell (incl. 'surface')",
  ...
  "alveoli" : "a place in lungs where you will find lots of simple squamous epithelium",
  ...
  "basal" : "what surface do stratified cells regenerate from",
...
export const tissuesB = {
  ...
  "elastic fibers" : "stretchable, but strong fibers made of proteins, elastin & fibrillin (incl. 'fibers')",
  ...
  "collagen glycoprotein" : "two substances that make up reticular fibers",
  "white" : "colour of reticular and collagen fibers",
  "lattice" : "word that describes the pattern of reticular fibers",
  "collagen fibers" : "fibers made up of strong, flexible bundles of a specific protein (incl. 'fibers')",
  ...
  "areolar tissue" : "loose connective tissue that makes up skin and lining of capillaries (incl. 'tissue')",
  ...
  "reticular tissue" : "loose connective tissue found in hollow organs, like liver, spleen & lymph nodes (incl. 'tissue')",
  ...
  "many" : "how many directions of strength do irregular connective tissues have",
  "irregular tissue" : "dense connective tissue found in skin, lining around bone/cartilage (periosteum, perichondrium) (incl. 'tissue')",
  "elastic tissue" : "dense connective tissue made of collagen & elastic fibers that stretch & recoil (incl. 'tissue')",
  "elastic tissue location" : "tissue found in arteries, ligamentum flava, aorta (incl. 'tissue location')",
}

export const tissuesC = {
  "membrane" : "body-lining sheet that can have either loose or dense connective tissue",
  ...
  "mucous membrane" : "substance that lines small intestine and inside of organs (respiratory, urinary, etc) (incl. 'membrane')",
  ...
  "serous location" : "membrane that surrounds lungs & heart (incl. 'location')",
  "synovial" : "lubricating membrane that includes ______ cells and loose connective tissue",
  ...
  "chondroitin sulfate" : "substance in cartilage ground substance that helps it take a lot of force/stress per area",
  ...
  "has articular cartilage does not" : "most hylaline ___ perichondrium, but _______",
...
export const tissuesD = {
  ...
  "metabolism" : "important whole body activity that epithelial cells can affect",
  "fibers" : "structural element of connective tissue that adds integrity to the tissue (incl. 's')",
