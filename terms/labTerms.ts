...
export const lab2Terms = {
  ...
  "capitulum" : "anterior bump on distal end of humerus, medial to the lateral epicondyle",
  "trochlea" : "anterior bump on distal end of humerus, lateral to the medial epicondyle",
